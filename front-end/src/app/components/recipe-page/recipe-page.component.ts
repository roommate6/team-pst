...
export class RecipePageComponent {
  ...
  recipeTest: Recipe = {
    ...
    Steps: [
      'Boil water and wait for it to boil and I add text to testand I add text to testand I add text to testand and I add text to testand I add text to testand I add text to testand I add text to testand I add text to testI add text to test',
      'Add pasta',
      'Cook for 10 minutes',
      'Drain water',
      'Add sauce',
